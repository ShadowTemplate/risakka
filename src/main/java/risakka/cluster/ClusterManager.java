...
public class ClusterManager {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Conf.SERVER_NUMBER; i++) {
            // TODO Move into ConfigFile
            String c = "akka.persistence.journal.plugin=\"akka.persistence.journal.leveldb\" \n" +
            ...
            actors.put(i, system.actorOf(Props.create(FooNode.class, i), "node" + i));
        }
